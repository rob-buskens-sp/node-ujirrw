...
var morganMiddleware = require('./middleware/morgan.middleware');
...
var resourceTypesRouter = require('./routes/resourceTypes');
...
app.use('/ServiceProviderConfig', serviceProviderRouter);
